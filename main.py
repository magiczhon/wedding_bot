...
btn7 = types.KeyboardButton('⬅️ Назад')
admin_menu.add(btn4, btn5, btn7)
...
def switch_to_user(message):
    ...
    if is_user_registered(user_id):
        bot.send_message(user_id, "Вы переключились в режим пользователя. 🎉\nДля переключения в режим администратора используйте команду /admin", reply_markup=main_menu)
    else:
